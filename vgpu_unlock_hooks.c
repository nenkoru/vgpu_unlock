...
static vgpu_unlock_vgpu_t vgpu_unlock_vgpu[] =
{
	...
	/* NVIDIA RTX 6000 Ada  */
	VGPU(0x26B1, 0x1708, "NVIDIA RTX6000-Ada-1B"),
	VGPU(0x26B1, 0x1709, "NVIDIA RTX6000-Ada-2B"),
	
	VGPU(0x26B1, 0x170A, "NVIDIA RTX6000-Ada-1Q"),
	VGPU(0x26B1, 0x170B, "NVIDIA RTX6000-Ada-2Q"),
	VGPU(0x26B1, 0x170C, "NVIDIA RTX6000-Ada-3Q"),
	VGPU(0x26B1, 0x170D, "NVIDIA RTX6000-Ada-4Q"),
	VGPU(0x26B1, 0x170E, "NVIDIA RTX6000-Ada-6Q"),
	VGPU(0x26B1, 0x170F, "NVIDIA RTX6000-Ada-8Q"),
	VGPU(0x26B1, 0x1710, "NVIDIA RTX6000-Ada-12Q"),
	VGPU(0x26B1, 0x1711, "NVIDIA RTX6000-Ada-16Q"),
	VGPU(0x26B1, 0x1712, "NVIDIA RTX6000-Ada-24Q"),
	VGPU(0x26B1, 0x1713, "NVIDIA RTX6000-Ada-48Q"),
	
	VGPU(0x26B1, 0x1714, "NVIDIA RTX6000-Ada-1A"),
	VGPU(0x26B1, 0x1715, "NVIDIA RTX6000-Ada-2A"),
	VGPU(0x26B1, 0x1716, "NVIDIA RTX6000-Ada-3A"),
	VGPU(0x26B1, 0x1717, "NVIDIA RTX6000-Ada-4A"),
	VGPU(0x26B1, 0x1718, "NVIDIA RTX6000-Ada-6A"),
	VGPU(0x26B1, 0x1719, "NVIDIA RTX6000-Ada-8A"),
	VGPU(0x26B1, 0x171A, "NVIDIA RTX6000-Ada-12A"),
	VGPU(0x26B1, 0x171B, "NVIDIA RTX6000-Ada-16A"),
	VGPU(0x26B1, 0x171C, "NVIDIA RTX6000-Ada-24A"),
	VGPU(0x26B1, 0x171D, "NVIDIA RTX6000-Ada-48A"),
